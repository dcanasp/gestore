...
const producto = async () => {
  ...
  let url = 'http://ec2-52-91-104-218.compute-1.amazonaws.com:1234'+'/getProduct/' + prod_id;
  let datos;
...
const getImages = async (product) => {
  let url = 'http://ec2-52-91-104-218.compute-1.amazonaws.com:1234'+'/getImages/' + product.image_id;
  let datos;
  const x = await fetch(url, {
    method: "GET",
    mode: "cors",
