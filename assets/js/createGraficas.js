...
let datos;
const x = await fetch('http://ec2-52-91-104-218.compute-1.amazonaws.com:1234'+'/ADMIN/getAllClients', {
    method : "GET",
    headers: {
...
let datos;
const x = await fetch('http://ec2-52-91-104-218.compute-1.amazonaws.com:1234'+'/ADMIN/getAllUsers', {
    method : "GET",
    headers: {
    'Content-Type': 'application/json',
    'Authorization': 'Bearer '+localStorage.getItem('token')
