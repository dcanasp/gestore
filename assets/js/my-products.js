...
const productos= async () =>{
    ...
    let url = 'http://ec2-52-91-104-218.compute-1.amazonaws.com:1234'+'/SELL/getProducts/'+String(user_id);
    let datos;
    const x = await fetch(url, {
        method : "GET",
        mode: 'cors',
...
const getImages = async (products) => {
    let url = 'http://ec2-52-91-104-218.compute-1.amazonaws.com:1234'+'/getAllImages';
    let datos;
    const x = await fetch(url, {
        method : "GET",
        mode: 'cors',
